...
screen navigation():
    ...
    vbox:
        ...
        if not any(map(lambda scrn: renpy.get_screen(scrn), ("save", "preferences", "load", "history"))):
...
style navigation_button_text:
    ...
    font "gui/font/comic.ttf"
    color "#FFF1B5" #FFD26A
    outlines [(4, "#FEB02F", 0, 0), (2, "#FEB02F", 2, 2)]
    hover_outlines [(4, "#FF7D01", 0, 0), (2, "#FF7D01", 2, 2)]
    insensitive_outlines [(4, "#FFCC85", 0, 0), (2, "#FFCC85", 2, 2)] #FFFFA3
...
style game_menu_label_text:
    ...
    size gui.title_text_size
    color "#FFDA96" #FFA502
    outlines [(6, "#FF8301", 0, 0), (3, "#FF8301", 2, 2)]
    yalign 0.5
...
style pref_label_text:
    ...
    size 24
    color "#FFD26A"
    outlines [(3, "#F7A329", 0, 0), (1, "#F7A329", 1, 1)]
    yalign 1.0
