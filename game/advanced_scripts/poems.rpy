...
Inside my head."""
    ...
    title = "%",
    text = """\
Убирайся из моей головы. Убирайся из моей головы. Убирайся из моей головы. Убирайся из моей головы. Убирайся из моей головы. Убирайся из моей головы. Убирайся из моей головы. Убирайся из моей головы. Убирайся из моей головы. Убирайся из моей головы. Убирайся из моей головы. Убирайся из моей головы. Убирайся из моей головы. Убирайся из моей головы. Убирайся из моей головы. Убирайся из моей головы. Убирайся из моей головы. Убирайся из моей головы. Убирайся из моей головы. Убирайся из моей головы. Убирайся из моей головы. Убирайся из моей головы. Убирайся из моей головы. Убирайся из моей головы. Убирайся из моей головы. Убирайся из моей головы. Убирайся из моей головы. Убирайся из моей головы. Убирайся из моей головы. Убирайся из моей головы. Убирайся из моей головы. Убирайся
Убирайся.
Из.
Моей.
Головы.\n\n\n
 Убирайся из моей головы, пока я не сделала то, что тебе же лучше.
 Убирайся из моей головы, прежде чем я прислушаюсь ко всему, что она сказала.
 Убирайся из моей головы, прежде чем я покажу, сколь сильно я тебя люблю.
...
Not all good times must come to an end."""
    ...
    poem_m5 = Poem(
    author = "monika",
    title = "Простите извините",
    text = """\
Я не приду в клуб сегодня, повеселитесь там без меня
Увидимся на следующей неделе, всё пока."""
    )
