...
define config.name = "Doki Doki: Absolution"
...
define build.name = "DDLCAbsolution"
...
# main menu music
define config.main_menu_music = audio.Eternity
...
define config.save_directory = "DDLC Absolution RUS"
...
#    build.classify('game/Credits.txt', build.name)
