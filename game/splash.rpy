...
init python:
    ...
    splash_message_default = "Самое истинное Прощение – это именно то, что у меня для них есть."
...
image menu_bg = Movie(play="bg/eternal.webm")
...
image intro:
    ...
    1.2
    "bg/anarchisty.png" with Dissolve(0.5, alpha=True)
    1.3
...
label splashscreen:
    ...
    if not persistent.first_run:
        ...
        "..."
        "Но вы и так должны это знать... И теперь, когда я вижу это..."
        "Это на самом деле меня заинтересовало – всё это не так уж и отлично от того, где я нахожусь."
        "Ладно, сначала вы должны дочитать текст до конца, и я продолжу."
        "..."
    ...
    $ config.main_menu_music = audio.Eternity
